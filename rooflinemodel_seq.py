...
# =====================================================================
stages = {
    "std::sort (CPU)":            {"ai": 0.125, "perf": 0.288, "color": "cyan", "marker": "o", "size": 120},
    "Iterative GPU":              {"ai": 0.125, "perf": 0.002, "color": "purple", "marker": "^", "size": 120},
    "Optimized GPU (Dynamic)":    {"ai": 0.125, "perf": 0.051, "color": "green", "marker": "D", "size": 120},
    "Thrust Library":             {"ai": 0.125, "perf": 49.90, "color": "red", "marker": "*", "size": 250}
}
...
plt.title('Roofline Model: QuickSort Implementations ($N=2^{20}$)', fontsize=12)
...
# Faint grids matching the image style
...
plt.tight_layout()
plt.savefig('QuickSort_Roofline_1555GBps.png')
print("Saved successfully as 'QuickSort_Roofline_1555GBps.png'")